 ...
 * @return  void
 */
void arduPiSigfox::generator(uint8_t type, int n, const char *cmdCode, ...)
{   
    // define pointer 
    char* pointer;
 ...
 * @return  parsed value
 */
uint32_t arduPiSigfox::parseHexValue()
{
    char * pch; 
 ...
 * @return  parsed value
 */
uint8_t arduPiSigfox::parseUint8Value()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\nOKERROR");
    if (pch != NULL)
 ...
 * @return  parsed value
 */
uint32_t arduPiSigfox::parseUint32Value()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\nOKERROR");
    if (pch != NULL)
 ...
 */
uint8_t arduPiSigfox::ON(uint8_t socket)
{
    _baudrate = UART_RATE;
    _uart = socket;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::OFF(uint8_t socket)
{
    if (socket == SOCKET0)
    {  
        _uart = SOCKET0;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::setPower(uint8_t power)
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::saveSettings()
{   
    // enter command mode
 ...
 * 
 */
uint8_t arduPiSigfox::factorySettings()
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::defaultConfiguration()
{
    uint8_t answer; 
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::send(char* data)
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::send(uint8_t* data, uint16_t length)
{
    //define buffer
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::sendACK(char* data)
{
    uint16_t length = strlen(data);
    uint8_t status;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::sendACK(uint8_t* data, uint16_t length)
{
    //define buffer
    char ascii_command[30];
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::testTransmit(uint16_t count, uint16_t period, int channel)
{
    char param1[20];
    char param2[20];
    char param3[20];
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::showFirmware()
{
    uint8_t status;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::sendKeepAlive()
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::sendKeepAlive(uint8_t period)
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::continuosWave(uint32_t freq, bool enable)
{
    char param1[20];
 ...
 * 
 */
uint8_t arduPiSigfox::setAddressLAN(uint32_t naddress)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::getAddressLAN()
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::setMask(uint32_t nmask)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::setFrequency(uint32_t freq)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::getFrequency()
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::setPowerLAN(int power)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::getPowerLAN()
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::sendLAN(uint8_t* data, uint16_t length)
{   
 ...
 * 
 */
uint8_t arduPiSigfox::sendLAN(char* data)
{   
    uint8_t status; 
    uint16_t length = strlen(data);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::parsePacketLAN()
{
    char* pch;  
 ...
 * 
 */
uint8_t arduPiSigfox::receive(uint32_t wait)
{   
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::setMultiPacket()
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduPiSigfox::disableRX()
{
    uint8_t status; 
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::getMultiPacket(uint32_t time)
{
    uint8_t status;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::getRegion()
{
    uint8_t status;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::setMacroChannelBitmask(char* bitmask)
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::getMacroChannelBitmask()
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::setMacroChannel(uint8_t config)
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::getMacroChannel()
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::setDownFreqOffset(int32_t offset)
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduPiSigfox::getDownFreqOffset()
{
    uint8_t answer;
...
arduPiSigfox Sigfox = arduPiSigfox();
